...
- `app/(public)/[locale]/business-segments/page.tsx:187,189,200,202` — sector icon-box `<Icon>`, accent-panel heading, badge text, and checkmark icon all go against a data-driven `accentBg`; for the `xay-lap-cong-trinh` sector this resolves to the light `#8ec63f`, making the previously-hardcoded `#78d750`/`#fff`/`#defbbc`/`#78d750` icon/text colors fail badly (ratios 1.03:1–2.04:1, need 4.5:1 text / 3:1 icon) → added an `accentIsLight` conditional that swaps all four to `#013d27` whenever `accentBg === '#8ec63f'` (icon 6.07:1, heading 6.07:1, badge-on-rgba(255,255,255,0.12)-composite 6.63:1, checkmark icon 6.07:1); the two darker sectors (`#015231`, `#013d27`) are unaffected and keep the original light-on-dark colors (9.34:1 / 12.37:1 heading, 6.04:1 / 7.73:1 badge)
