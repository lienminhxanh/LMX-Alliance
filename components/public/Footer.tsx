...
export function Footer() {
  ...
  return (
    <footer className="mt-auto text-white" style={{ background: '#0f1e0d' }}>
      <div className="container-max py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-7 h-7 bg-white flex items-center justify-center flex-shrink-0">
                <span className="text-xs font-bold" style={{ color: '#0f1e0d' }}>LMX</span>
              </div>
              <span className="font-semibold" style={{ fontFamily: 'var(--font-display)' }}>LMX Alliance</span>
            </div>
            <p className="text-sm leading-relaxed max-w-xs" style={{ color: '#c4e070' }}>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm transition-colors hover:text-white" style={{ color: '#a8cc28' }}>
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex gap-2.5 text-sm" style={{ color: '#c4e070' }}>
        ...
        <div className="mt-10 pt-6" style={{ borderTop: '1px solid #1d3212' }}>
          <p className="text-xs" style={{ color: '#a8cc28' }}>{t('rights')}</p>
        </div>
      </div>
    </footer>
  );
