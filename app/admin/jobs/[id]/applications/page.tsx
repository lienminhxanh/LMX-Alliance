  ...
  return (
    <div className="p-8">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-[#1F2937]" style={{ fontFamily: 'var(--font-display)' }}>Applications</h1>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-[#E8E9ED]">
              <th className="px-4 py-3 text-left text-xs font-semibold text-[#6B7280] uppercase">Applicant</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-[#6B7280] uppercase">Contact</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-[#6B7280] uppercase">Status</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-[#6B7280] uppercase">Applied</th>
          ...
          <tbody>
            ...
            {job.applications.length === 0 && (
              <tr><td colSpan={5} className="px-4 py-8 text-center text-[#6B7280]">No applications yet</td></tr>
            )}
          </tbody>
        </table>
      </Card>
